local symbols = require("vista-nvim.symbols.symbols")
local ui = require("vista-nvim.ui.ui")
local config = require("vista-nvim.config")
local t_utils = require("vista-nvim.provider.utils.table")
                    ...
                    elseif depth > 1 then
                        if node.isLast then
                            ...
                            add_guide_hl(
                                running_length,
                                running_length
                                    + vim.fn.strlen(ui.markers.bottom)
                                    - 1
                            )
                        else
                            ...
                            add_guide_hl(
                                running_length,
                                running_length
                                    + vim.fn.strlen(ui.markers.middle)
                                    - 1
                            )
                        end
                    end
